...
command! -nargs=? VkApply call vimkube#Apply(<q-args>)
command! -nargs=+ VkEdit call vimkube#Edit(<f-args>)
command! -nargs=* VkDelete call vimkube#Delete(<q-args>)
...
command! -nargs=? VkNamespace call vimkube#Namespace(<q-args>)
...
command! -nargs=1 VkEditTemplate call vimkube#templates#EditTemplate(<q-args>)
command! -nargs=1 VkDeleteTemplate call vimkube#templates#DeleteTemplate(<q-args>)
